...
export function useRefHistory(initialValue) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return navigator.clipboard.writeText(options.source);
          case 3:
            _context.next = 9;
            break;
          case 5:
...
export function useBase64(file) {
