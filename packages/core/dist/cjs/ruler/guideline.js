...
exports.setupGuideLine = setupGuideLine;
var _fabric = require("fabric");
/* eslint-disable @typescript-eslint/no-explicit-any */
/* eslint-disable @typescript-eslint/no-unused-vars */

function setupGuideLine() {
  if (_fabric.fabric.GuideLine) {
    return;
  }
  _fabric.fabric.GuideLine = _fabric.fabric.util.createClass(_fabric.fabric.Line, {
    type: 'GuideLine',
    selectable: false,
    hasControls: false,
    hasBorders: false,
    ...
    isPointOnRuler: function isPointOnRuler(e) {
      var isHorizontal = this.isHorizontal();
      var hoveredRuler = this.canvas.ruler.isPointOnRuler(new _fabric.fabric.Point(e.offsetX, e.offsetY));
  ...
  _fabric.fabric.GuideLine.fromObject = function (object, callback) {
    var clone = _fabric.fabric.util.object.clone;
    ...
    _fabric.fabric.Object._fromObject(options.type, options, _callback, 'xy');
  };
}
var _default = _fabric.fabric.GuideLine;
