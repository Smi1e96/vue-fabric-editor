    ...
    value: function init() {
      ...
      canvas.on('object:moving', function (e) {
        ...
        for (var i = canvasObjects.length; i--;) {
          ...
          // 排除辅助线
          if (activeObject instanceof _fabric.fabric.GuideLine && canvasObjects[i] instanceof _fabric.fabric.GuideLine) {
            continue;
          }
          ...
          if (isInRange(objectLeft, activeObjectLeft)) {
            ...
            activeObject.setPositionByOrigin(new _fabric.fabric.Point(objectLeft, activeObjectTop), 'center', 'center');
          }
          ...
          if (isInRange(objectLeft - objectWidth / 2, activeObjectLeft - activeObjectWidth / 2)) {
            ...
            activeObject.setPositionByOrigin(new _fabric.fabric.Point(objectLeft - objectWidth / 2 + activeObjectWidth / 2, activeObjectTop), 'center', 'center');
          }
          ...
          if (isInRange(objectTop, activeObjectTop)) {
            ...
            activeObject.setPositionByOrigin(new _fabric.fabric.Point(activeObjectLeft, objectTop), 'center', 'center');
          }
          ...
          if (isInRange(objectTop - objectHeight / 2, activeObjectTop - activeObjectHeight / 2)) {
            ...
            activeObject.setPositionByOrigin(new _fabric.fabric.Point(activeObjectLeft, objectTop - objectHeight / 2 + activeObjectHeight / 2), 'center', 'center');
          }
...
var _default = AlignGuidLinePlugin;
