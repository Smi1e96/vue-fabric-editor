...
var WorkspacePlugin = /*#__PURE__*/function () {
  ...
  _createClass(WorkspacePlugin, [{
    ...
    value: function _initResizeObserve() {
      var _this3 = this;
      var resizeObserver = new ResizeObserver((0, _lodashEs.throttle)(function () {
        _this3.auto();
      }, 50));
      if (this.workspaceEl) {
    ...
    value: function setZoomAuto(scale, cb) {
      ...
      if (workspaceEl) {
        ...
        this.canvas.setViewportTransform(_fabric.fabric.iMatrix.concat());
        this.canvas.zoomToPoint(new _fabric.fabric.Point(center.left, center.top), scale);
    ...
    value: function big() {
      ...
      zoomRatio += 0.05;
      var center = this.canvas.getCenter();
      this.canvas.zoomToPoint(new _fabric.fabric.Point(center.left, center.top), zoomRatio);
    }
    ...
    value: function small() {
      ...
      zoomRatio -= 0.05;
      var center = this.canvas.getCenter();
      this.canvas.zoomToPoint(new _fabric.fabric.Point(center.left, center.top), zoomRatio < 0 ? 0.01 : zoomRatio);
    }
    ...
    value: function _bindWheel() {
      this.canvas.on('mouse:wheel', function (opt) {
        ...
        this.zoomToPoint(new _fabric.fabric.Point(center.left, center.top), zoom);
