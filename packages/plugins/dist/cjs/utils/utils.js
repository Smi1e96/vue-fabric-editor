...
exports.clipboardText = void 0;
exports.downFontByJSON = downFontByJSON;
exports.getImgStr = getImgStr;
exports.insertImgFile = insertImgFile;
...
function getImgStr(file) {
  return (0, _useHooks.useBase64)(file).promise;
}
 ...
 * @return {Promise}
 */
function downFontByJSON(str) {
  var skipFonts = ['arial', 'Microsoft YaHei'];
  var fontFamilies = JSON.parse(str).objects.filter(function (item) {
    return (
      // 为text 并且不为包含字体
  ...
  var fontFamiliesAll = fontFamilies.map(function (fontName) {
    var font = new _fontfaceobserver.default(fontName);
...
function selectFiles(options) {
  return new Promise(function (resolve) {
    var _useFileDialog = (0, _useHooks.useFileDialog)(options),
      onChange = _useFileDialog.onChange,
      open = _useFileDialog.open;
 ...
 */
var clipboardText = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _useHooks.useClipboard)(_objectSpread({
            source: source
          }, options)).copy();
        case 3:
          _context.next = 8;
  ...
  return function clipboardText(_x, _x2) {
