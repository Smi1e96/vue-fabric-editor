...
var ControlsRotatePlugin = /*#__PURE__*/function () {
  ...
  _createClass(ControlsRotatePlugin, [{
    ...
    value: function init() {
      ...
      // ↖左上
      _fabric.fabric.Object.prototype.controls.mtr2 = new _fabric.fabric.Control({
        x: 0.5,
        y: -0.5,
        offsetY: -10,
        offsetX: 10,
      ...
      _fabric.fabric.Object.prototype.controls.mtr3 = new _fabric.fabric.Control({
        x: 0.5,
        y: 0.5,
        offsetY: 10,
        offsetX: 10,
      ...
      _fabric.fabric.Object.prototype.controls.mtr4 = new _fabric.fabric.Control({
        x: -0.5,
        y: 0.5,
        offsetY: 10,
        offsetX: -10,
      ...
      canvas.on('after:render', function () {
        ...
        if (angle !== undefined) {
          _fabric.fabric.Object.prototype.controls.mtr.cursorStyle = rotateIcon(Number(angle));
          _fabric.fabric.Object.prototype.controls.mtr2.cursorStyle = rotateIcon(Number(angle) + 90);
          _fabric.fabric.Object.prototype.controls.mtr3.cursorStyle = rotateIcon(Number(angle) + 180);
          _fabric.fabric.Object.prototype.controls.mtr4.cursorStyle = rotateIcon(Number(angle) + 270);
        }
      });
...
var _default = ControlsRotatePlugin;
