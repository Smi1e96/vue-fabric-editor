...
var CanvasRuler = /*#__PURE__*/function () {
  ...
  _createClass(CanvasRuler, [{
    ...
    value: function clearGuideline() {
      ...
      (_this$options$canvas = this.options.canvas).remove.apply(_this$options$canvas, _toConsumableArray(this.options.canvas.getObjects(fabric.GuideLine.prototype.type)));
    }
    ...
    value: function showGuideline() {
      this.options.canvas.getObjects(fabric.GuideLine.prototype.type).forEach(function (guideLine) {
    ...
    value: function draw(opt) {
      ...
      // 颜色
      var textColor = new fabric.Color(this.options.textColor);
      // 标尺文字显示
      ...
      if (this.objectRect) {
        ...
        this.objectRect[axis].forEach(function (rect) {
          ...
          drawMask(_this2.ctx, _objectSpread(_objectSpread({}, maskOpt), {}, {
          ...
          // 颜色
          var highlightColor = new fabric.Color(_this2.options.highlightColor);
          ...
          darwText(_this2.ctx, _objectSpread(_objectSpread({}, textOpt), {}, {
            text: leftTextVal,
          ...
          darwLine(_this2.ctx, _objectSpread(_objectSpread({}, lineOpt), {}, {
