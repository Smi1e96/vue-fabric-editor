...
import { useFileDialog, useBase64 } from "./useHooks";
/**
...
export function selectFiles(options) {
  return new Promise(function (resolve) {
    var _useFileDialog = useFileDialog(options),
 ...
 */
export var clipboardText = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return useClipboard(_objectSpread({
            source: source
          }, options)).copy();
        case 3:
          _context.next = 8;
